                            ...
                            Column(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                        TakemedicinedaydetailWidget.routeName);
                                  },
                                  child: Container(
                                    width: 40.0,
                                    height: 40.0,
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: CircularPercentIndicator(
                                            ...
                                            animation: true,
                                            animateFromLastPercent: true,
                                            progressColor: Color(0xFFF5884A),
                                            backgroundColor:
                                                FlutterFlowTheme.of(context)
                                                    .accent4,
                                            startAngle: 90.0,
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: PageView(
                            ...
                            children: [
                              wrapWithModel(
                                model: _model.missionInprogressModel,
                                updateCallback: () => safeSetState(() {}),
                                child: MissionInprogressWidget(),
                              ),
                              wrapWithModel(
                                model: _model.missionUnsuccessModel,
                                updateCallback: () => safeSetState(() {}),
                                child: MissionUnsuccessWidget(),
                              ),
                              wrapWithModel(
                                model: _model.missionSuccessModel,
                                updateCallback: () => safeSetState(() {}),
                                child: MissionSuccessWidget(),
                              ),
                              wrapWithModel(
                                model: _model.missionNonstartModel,
                                updateCallback: () => safeSetState(() {}),
                                child: MissionNonstartWidget(),
                              ),
                            ],
                          ),
                        ),
