...
import 'mission_inprogress_model.dart';
export 'mission_inprogress_model.dart';

class MissionInprogressWidget extends StatefulWidget {
  const MissionInprogressWidget({super.key});

  @override
  State<MissionInprogressWidget> createState() =>
      _MissionInprogressWidgetState();
}

class _MissionInprogressWidgetState extends State<MissionInprogressWidget> {
  late MissionInprogressModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MissionInprogressModel());
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                colors: [Color(0xFFFADECA), Color(0xFFFFF4EA)],
                stops: [0.0, 1.0],
