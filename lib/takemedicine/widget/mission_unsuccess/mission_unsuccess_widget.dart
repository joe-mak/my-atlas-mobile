...
import 'mission_unsuccess_model.dart';
export 'mission_unsuccess_model.dart';

class MissionUnsuccessWidget extends StatefulWidget {
  const MissionUnsuccessWidget({super.key});

  @override
  State<MissionUnsuccessWidget> createState() => _MissionUnsuccessWidgetState();
}

class _MissionUnsuccessWidgetState extends State<MissionUnsuccessWidget> {
  late MissionUnsuccessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MissionUnsuccessModel());
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                colors: [Color(0xFFFFE8E8), Color(0xFFFFF7F7)],
                stops: [0.0, 1.0],
