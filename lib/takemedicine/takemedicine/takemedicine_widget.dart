...
import 'takemedicine_model.dart';
export 'takemedicine_model.dart';

class TakemedicineWidget extends StatefulWidget {
  const TakemedicineWidget({super.key});

  static String routeName = 'Takemedicine';
  static String routePath = '/takemedicine';

  @override
  State<TakemedicineWidget> createState() => _TakemedicineWidgetState();
}

class _TakemedicineWidgetState extends State<TakemedicineWidget> {
  late TakemedicineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TakemedicineModel());
          ...
          child: Stack(
            children: [
              ...
              Align(
                ...
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 16.0, 32.0),
                  child: wrapWithModel(
                    model: _model.addDrugButttonModel,
                    updateCallback: () => safeSetState(() {}),
                    child: AddDrugButttonWidget(),
                  ),
                ),
              ),
            ],
