...
import '/health/temperature/knowledgetemperature/knowledgetemperature_widget.dart';
import '/health/temperature/temperature_history/temperature_history_widget.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed(AddTemperatureWidget.routeName);
                          },
                          child: Row(
                              ...
                              builder: (context) {
                                return GestureDetector(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TemperatureHistoryWidget(),
                                  ),
                                );
                              },
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              width: double.infinity,
                              height: double.infinity,
                              child: custom_widgets.TempChart(
                                width: double.infinity,
                                height: double.infinity,
                              ),
                            ),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      await launchURL(
                                          'https://www.bpksamutprakan.com/care_blog/view/381');
                                    },
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                    ...
                    showModalBottomSheet(
                      ...
                      builder: (context) {
                        return GestureDetector(
                          ...
                          child: Padding(
                            padding: MediaQuery.viewInsetsOf(context),
                            child: KnowledgetemperatureWidget(),
                          ),
                        );
                      },
                    ).then((value) => safeSetState(() {}));
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                'เรียนรู้เพิ่มเติมเกี่ยวกับอุณหภูมิของร่างกาย',
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
