...
import 'temperature_history_model.dart';
export 'temperature_history_model.dart';
...
class _TemperatureHistoryWidgetState extends State<TemperatureHistoryWidget> {
  late TemperatureHistoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TemperatureHistoryModel());
