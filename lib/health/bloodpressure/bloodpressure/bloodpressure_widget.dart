...
import '/health/bloodpressure/knowledgebloodpressure/knowledgebloodpressure_widget.dart';
...
import 'bloodpressure_model.dart';
export 'bloodpressure_model.dart';

class BloodpressureWidget extends StatefulWidget {
  const BloodpressureWidget({super.key});

  static String routeName = 'bloodpressure';
  static String routePath = '/bloodpressure';
...
class _BloodpressureWidgetState extends State<BloodpressureWidget>
  ...
  late BloodpressureModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BloodpressureModel());
                    ...
                    child: Column(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed(AddBloodpressureWidget.routeName);
                          },
                          child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              width: double.infinity,
                              height: double.infinity,
                              child: custom_widgets.Bloodpressure(
                                width: double.infinity,
                                height: double.infinity,
                              ),
                            ),
                    ...
                    showModalBottomSheet(
                      ...
                      builder: (context) {
                        return GestureDetector(
                          ...
                          child: Padding(
                            padding: MediaQuery.viewInsetsOf(context),
                            child: KnowledgebloodpressureWidget(),
                          ),
                        );
                      },
                    ).then((value) => safeSetState(() {}));
                      ...
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/bloodpressur.png',
                              width: double.infinity,
                              height: () {
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                'เรียนรู้เพิ่มเติมเกี่ยวกับความดันโลหิตของคุณ',
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
