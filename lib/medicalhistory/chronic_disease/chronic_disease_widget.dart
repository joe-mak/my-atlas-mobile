...
class ChronicDiseaseWidget extends StatefulWidget {
  const ChronicDiseaseWidget({super.key});

  static String routeName = 'ChronicDisease';
  static String routePath = '/chronicDisease';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [Color(0x0EFF6C00), Color(0x17FF6C00)],
                            stops: [0.0, 1.0],
                            begin: AlignmentDirectional(0.56, -1.0),
                            end: AlignmentDirectional(-0.56, 1.0),
                          ),
