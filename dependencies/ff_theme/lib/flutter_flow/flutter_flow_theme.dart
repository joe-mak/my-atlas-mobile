...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1D8B6B);
  late Color secondary = const Color(0xFF57B99C);
  late Color tertiary = const Color(0xFFADDFD0);
  ...
  late Color success = const Color(0xFF1CB834);
  late Color warning = const Color(0xFFFFA500);
  late Color error = const Color(0xFFFF4242);
  late Color info = const Color(0xFF4A99F5);
}
